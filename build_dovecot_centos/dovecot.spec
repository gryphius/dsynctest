...
Source0: http://www.dovecot.org/releases/2.1/%{name}-%{version}.tar.gz
...
%configure                       \
    ...
    %{?with_systemd:--with-systemdsystemunitdir=/lib/systemd/system/} \
    --with-docs
...
* Fri Feb 06 2007 Troy Engel <tengel@fluid.com> - 1.0-2_45.rc22
